      ...
      <?php } ?>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-content dropdown-menu-right animate slideIn" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item disabled" href="babyprods.php">Baby products</a>
...
$sql = 'SELECT id , descpt, brand, qty, price , logo FROM baby_products';
...
?>
    ...
    <div class="card-body text-center">
        ...
        <form method="POST" action="bpitem.php">
